...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\Post::factory(40)->create()->each( function($post) {
           $post->image()->save(\App\Models\Image::factory()->make([ 'url'=> 'https://picsum.photos/1024/1024'  ])); 
        ...
        \App\Models\Video::factory(40)->create()->each( function($video) {
            $video->image()->save(\App\Models\Image::factory()->make([ 'url'=> 'https://picsum.photos/1024/1024'  ]));
